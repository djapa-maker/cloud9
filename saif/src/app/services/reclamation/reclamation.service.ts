...
export class ReclamationService {
  private ajouterurl ='http://localhost:8085/saif/addReclamation';
  private listurl ='http://localhost:8085/saif/retrieveAllReclamations';
  private modifierurl = 'http://localhost:8085/saif/update_reclamation';
  private userUrl='http://localhost:8085/saif/retrieveAllUsers';
  private Url='http://localhost:8085/saif';
  private apiUrl = 'http://localhost:8085/saif/reclamationStats';
  private apiReponseAjout ='http://localhost:8085/saif/addReponse';
  private apiReponseaffiche='http://localhost:8085/saif/retrieveAllReponse';
 ...
 listreclamation() {
  ...
  listreponse() {
   ...
   getReclamation(id: any) {
     return this.http.get('http://localhost:8085/saif/get_reclamation/' + id)
   }

   

   getReponse(id: any) {
    return this.http.get('http://localhost:8085/saif/getReponse/' + id)
  }
